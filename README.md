...
1. classifica localmente o contexto temporal e usa a primeira frase, limitada a 200 caracteres, como query; estados atuais recebem a data absoluta da verificação;
